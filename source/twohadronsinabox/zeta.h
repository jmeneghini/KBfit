...
// *                                                                *
// *   We require that "usq", "gam", and the components of "s"      *
// *   are all REAL. Note that "usq" can be negative, which makes   *
// *   qstar imaginary.                                             *
// *                                                                *
// *   Recall that                                                  *
// *                                                                *
...
cmplx zetaRGL(int l, int m, const std::vector<double>& s, double gam,
              double usq);

double zetaRGL_re(int l, int m, const std::vector<double>& s, double gam,
                  double usq);

double zetaRGL_im(int l, int m, const std::vector<double>& s, double gam,
                  double usq);
...
public:
  ...
  WZetaRGLCalculator(const std::vector<double>& s, double gam, double usq);

  ~WZetaRGLCalculator() {}

  void reset(const std::vector<double>& s, double gam, double usq);

  void reset_if_diff(const std::vector<double>& s, double gam, double usq);
