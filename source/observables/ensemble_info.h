...
// *                                                                 *
// *  The special id "indep" indicates an observable that is         *
// *  independent of the ensemble, such as a K-matrix parameter.     *
// *                                                                 *
// *  To specify an ensemble not known to KBFit, you must provide    *
...
public:
  ...
  MCEnsembleInfo(uint nsamplings); // special "indep" constructor

  MCEnsembleInfo(XMLHandler& xml_in, uint nsamplings);
  ...
  bool operator==(const MCEnsembleInfo& rhs) const {
