...
public:
  ...
  Array(int size1, int size2, int size3, int size4, int size5);
  Array(int size1, int size2, int size3, int size4, int size5, int size6);
  Array(int size1, int size2, int size3, int size4, int size5, int size6,
        int size7);
  Array(int size1, int size2, int size3, int size4, int size5, int size6,
        int size7, int size8);
  ...
  const T& operator()(int i0, int i1, int i2, int i3, int i4, int i5,
                      int i6) const;
  T& operator()(int i0, int i1, int i2, int i3, int i4, int i5, int i6, int i7);
  const T& operator()(int i0, int i1, int i2, int i3, int i4, int i5, int i6,
                      int i7) const;
  ...
  Array<T>& resize(int size1, int size2, int size3, int size4, int size5);
  Array<T>& resize(int size1, int size2, int size3, int size4, int size5,
                   int size6);
  Array<T>& resize(int size1, int size2, int size3, int size4, int size5,
                   int size6, int size7);
  Array<T>& resize(int size1, int size2, int size3, int size4, int size5,
                   int size6, int size7, int size8);
...
template <typename T>
Array<T>::Array(int size1) : m_sizes(1), m_store(abs(size1)) {
  if (size1 < 1)
...
template <typename T>
Array<T>::Array(int size1, int size2, int size3, int size4, int size5)
    : m_sizes(5), m_store(abs(size1 * size2 * size3 * size4 * size5)) {
  if ((size1 < 1) || (size2 < 1) || (size3 < 1) || (size4 < 1) || (size5 < 1))
    throw(std::invalid_argument("Invalid Array size"));
  m_sizes[0] = size1;
  m_sizes[1] = size2;
  m_sizes[2] = size3;
...
Array<T>::Array(int size1, int size2, int size3, int size4, int size5,
                int size6, int size7)
    : m_sizes(7),
      m_store(abs(size1 * size2 * size3 * size4 * size5 * size6 * size7)) {
  if ((size1 < 1) || (size2 < 1) || (size3 < 1) || (size4 < 1) || (size5 < 1) ||
      (size6 < 1) || (size7 < 1))
    throw(std::invalid_argument("Invalid Array size"));
  m_sizes[0] = size1;
...
Array<T>::Array(int size1, int size2, int size3, int size4, int size5,
                int size6, int size7, int size8)
    : m_sizes(8), m_store(abs(size1 * size2 * size3 * size4 * size5 * size6 *
                              size7 * size8)) {
  if ((size1 < 1) || (size2 < 1) || (size3 < 1) || (size4 < 1) || (size5 < 1) ||
      (size6 < 1) || (size7 < 1) || (size8 < 1))
    throw(std::invalid_argument("Invalid Array size"));
  m_sizes[0] = size1;
  m_sizes[1] = size2;
  m_sizes[2] = size3;
...
Array<T>::Array(const std::vector<int>& sizevals)
  ...
  for (std::vector<int>::const_iterator it = sizevals.begin();
       it != sizevals.end(); ++it) {
    if (*it < 1)
      throw(std::invalid_argument("Invalid Array size"));
  }
...
Array<T>::Array(const std::vector<unsigned int>& sizevals)
  ...
  for (std::vector<unsigned int>::const_iterator it = sizevals.begin();
       it != sizevals.end(); ++it) {
    if (*it < 1)
      throw(std::invalid_argument("Invalid Array size"));
  }
...
Array<T>::Array(const std::vector<int>& sizevals, const T& initial_value)
    : m_sizes(sizevals.begin(), sizevals.end()),
      m_store(prod(sizevals), initial_value) {
  for (std::vector<int>::const_iterator it = sizevals.begin();
       it != sizevals.end(); ++it) {
    if (*it < 1)
      throw(std::invalid_argument("Invalid Array size"));
...
template <typename T> inline Array<T>& Array<T>::operator=(const T& val) {
...
#ifdef SAFETY_FLAG
  if (m_sizes.size() != 1)
    throw(std::invalid_argument("Array: improper rank of array indices"));
  if ((i < 0) || (i >= int(m_sizes[0])))
    throw(std::invalid_argument("Array: index out of range"));
#endif
  return m_store[i];
}

template <typename T> inline const T& Array<T>::operator[](int i) const {
#ifdef SAFETY_FLAG
  if (m_sizes.size() != 1)
    throw(std::invalid_argument("Array: improper rank of array indices"));
  if ((i < 0) || (i >= int(m_sizes[0])))
...
template <typename T> inline T& Array<T>::operator()(int i0, int i1) {
#ifdef SAFETY_FLAG
  if (m_sizes.size() != 2)
    throw(std::invalid_argument("Array: improper rank of array indices"));
  if ((i0 < 0) || (i0 >= int(m_sizes[0])))
    throw(std::invalid_argument("Array: 1st index out of range"));
  if ((i1 < 0) || (i1 >= int(m_sizes[1])))
    throw(std::invalid_argument("Array: 2nd index out of range"));
#endif
...
template <typename T> inline T& Array<T>::operator()(int i0, int i1, int i2) {
#ifdef SAFETY_FLAG
  if (m_sizes.size() != 3)
    throw(std::invalid_argument("Array: improper rank of array indices"));
  if ((i0 < 0) || (i0 >= int(m_sizes[0])))
  ...
  if ((i1 < 0) || (i1 >= int(m_sizes[1])))
    throw(std::invalid_argument("Array: 2nd index out of range"));
  if ((i2 < 0) || (i2 >= int(m_sizes[2])))
    throw(std::invalid_argument("Array: 3rd index out of range"));
#endif
...
inline T& Array<T>::operator()(int i0, int i1, int i2, int i3) {
  ...
  if ((i2 < 0) || (i2 >= int(m_sizes[2])))
    throw(std::invalid_argument("Array: 3rd index out of range"));
  if ((i3 < 0) || (i3 >= int(m_sizes[3])))
    throw(std::invalid_argument("Array: 4th index out of range"));
#endif
...
template <typename T>
inline T& Array<T>::operator()(int i0, int i1, int i2, int i3, int i4) {
#ifdef SAFETY_FLAG
  if (m_sizes.size() != 5)
    throw(std::invalid_argument("Array: improper rank of array indices"));
  if ((i0 < 0) || (i0 >= int(m_sizes[0])))
  ...
  if ((i3 < 0) || (i3 >= int(m_sizes[3])))
    throw(std::invalid_argument("Array: 4th index out of range"));
  if ((i4 < 0) || (i4 >= int(m_sizes[4])))
    throw(std::invalid_argument("Array: 5th index out of range"));
#endif
  return m_store[i0 +
                 m_sizes[0] *
                     (i1 +
                      m_sizes[1] * (i2 + m_sizes[2] * (i3 + m_sizes[3] * i4)))];
}
...
template <typename T>
inline T& Array<T>::operator()(int i0, int i1, int i2, int i3, int i4, int i5) {
#ifdef SAFETY_FLAG
  if (m_sizes.size() != 6)
    throw(std::invalid_argument("Array: improper rank of array indices"));
  if ((i0 < 0) || (i0 >= int(m_sizes[0])))
  ...
  if ((i4 < 0) || (i4 >= int(m_sizes[4])))
    throw(std::invalid_argument("Array: 5th index out of range"));
  if ((i5 < 0) || (i5 >= int(m_sizes[5])))
    throw(std::invalid_argument("Array: 6th index out of range"));
#endif
  return m_store[i0 +
                 m_sizes[0] *
                     (i1 + m_sizes[1] *
...
template <typename T>
inline const T& Array<T>::operator()(int i0, int i1, int i2, int i3, int i4,
                                     int i5) const {
#ifdef SAFETY_FLAG
  if (m_sizes.size() != 6)
    throw(std::invalid_argument("Array: improper rank of array indices"));
...
inline T& Array<T>::operator()(int i0, int i1, int i2, int i3, int i4, int i5,
  ...
  if ((i5 < 0) || (i5 >= int(m_sizes[5])))
    throw(std::invalid_argument("Array: 6th index out of range"));
  if ((i6 < 0) || (i6 >= int(m_sizes[6])))
    throw(std::invalid_argument("Array: 7th index out of range"));
#endif
  return m_store[i0 +
                 m_sizes[0] *
                     (i1 + m_sizes[1] *
...
inline T& Array<T>::operator()(int i0, int i1, int i2, int i3, int i4, int i5,
  ...
  if ((i6 < 0) || (i6 >= int(m_sizes[6])))
    throw(std::invalid_argument("Array: 7th index out of range"));
  if ((i7 < 0) || (i7 >= int(m_sizes[7])))
    throw(std::invalid_argument("Array: 8th index out of range"));
#endif
  return m_store
      [i0 +
       m_sizes[0] *
...
#endif
  if (m_sizes.empty())
    throw(std::invalid_argument("Empty Array...element access not possible"));
...
template <typename T> inline uint Array<T>::size(int i) const {
#ifdef SAFETY_FLAG
  if ((i < 0) || (i >= int(m_sizes.size())))
    throw(std::invalid_argument("Array size index out of range"));
#endif
  return m_sizes[i];
}

template <typename T> Array<T>& Array<T>::resize() { return clear(); }

template <typename T> Array<T>& Array<T>::resize(int size1) {
  if (size1 < 1)
    throw(std::invalid_argument("Invalid Array size"));
  m_sizes.resize(1);
  m_sizes[0] = size1;
...
template <typename T> Array<T>& Array<T>::resize(int size1, int size2) {
  if ((size1 < 1) || (size2 < 1))
    throw(std::invalid_argument("Invalid Array size"));
  m_sizes.resize(2);
  m_sizes[0] = size1;
...
unsigned int Array<T>::prod(const std::vector<uint>& ivec) const {
  unsigned int res = 1;
  for (std::vector<unsigned int>::const_iterator it = ivec.begin();
       it != ivec.end(); ++it)
    res *= (*it);
  if (res < 0)
    res = -res;
...
template <typename T> int Array<T>::prod(const std::vector<int>& ivec) const {
  int res = 1;
  for (std::vector<int>::const_iterator it = ivec.begin(); it != ivec.end();
       ++it)
    res *= (*it);
  if (res < 0)
    res = -res;
