...
template <typename T> void IOHandler::write_basic(const T& output) {
...
template <typename T>
void IOHandler::write_complex_vector(
...
template <typename T> void IOHandler::read_basic(T& input) {
  read_common((char*)&input, sizeof(T), 1);
}

template <typename T> void IOHandler::read_complex(std::complex<T>& input) {
  T data[2];
  read_common((char*)&data, sizeof(T), 2);
  input = std::complex<T>(data[0], data[1]);
}

template <typename T> void IOHandler::multi_read_basic(T* input, int n) {
...
template <typename T> void IOHandler::read_basic_vector(std::vector<T>& input) {
  int n;
  read_basic<int>(n);
  if (n == 0)
    return;
...
template <typename T> size_t IOHandler::numbytes_basic(const T& data) const {
  return sizeof(T);
}
...
template <typename T>
size_t IOHandler::numbytes_complex_vector(
...
inline void write(IOHandler& ioh, const char& output) { ioh.write(output); }

inline void write(IOHandler& ioh, const int& output) { ioh.write(output); }

inline void write(IOHandler& ioh, const unsigned int& output) {
  ioh.write(output);
}

inline void write(IOHandler& ioh, const long int& output) { ioh.write(output); }
...
inline void write(IOHandler& ioh, const float& output) { ioh.write(output); }

inline void write(IOHandler& ioh, const double& output) { ioh.write(output); }

inline void write(IOHandler& ioh, const bool& output) { ioh.write(output); }

inline void write(IOHandler& ioh, const fcmplx& output) { ioh.write(output); }

inline void write(IOHandler& ioh, const dcmplx& output) { ioh.write(output); }
...
inline void write(IOHandler& ioh,
...
inline void read(IOHandler& ioh, std::string& input) { ioh.read(input); }

inline void read(IOHandler& ioh, char& input) { ioh.read(input); }

inline void read(IOHandler& ioh, int& input) { ioh.read(input); }

inline void read(IOHandler& ioh, unsigned int& input) { ioh.read(input); }

inline void read(IOHandler& ioh, long int& input) { ioh.read(input); }

inline void read(IOHandler& ioh, unsigned long int& input) { ioh.read(input); }

inline void read(IOHandler& ioh, long long int& input) { ioh.read(input); }

inline void read(IOHandler& ioh, unsigned long long int& input) {
  ioh.read(input);
}

inline void read(IOHandler& ioh, float& input) { ioh.read(input); }

inline void read(IOHandler& ioh, double& input) { ioh.read(input); }

inline void read(IOHandler& ioh, bool& input) { ioh.read(input); }

inline void read(IOHandler& ioh, fcmplx& input) { ioh.read(input); }

inline void read(IOHandler& ioh, dcmplx& input) { ioh.read(input); }

inline void read(IOHandler& ioh, std::vector<char>& input) { ioh.read(input); }

inline void read(IOHandler& ioh, std::vector<int>& input) { ioh.read(input); }
...
inline void read(IOHandler& ioh, std::vector<float>& input) { ioh.read(input); }
...
inline size_t numbytes(IOHandler& ioh,
