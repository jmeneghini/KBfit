...
// *                                                                        *
// *    Fit K-matrix parameters using either determinant residual method    *
...
// *           -- to store K-matrix fit parameters samplings                *
// *           -- caution: overwrite is assumed!!                           *
// *                                                                        *
// *       <EcmQcmBoxSamplingsStub>...</EcmQcmBoxSamplingsStub> (optional)  *
// *           -- to save Ecm/mref, qcm/mref, box matrix element samplings; *
// *                one file for each ensemble  .ens0, .ens1, ...           *
// *           -- caution: overwrite is assumed!!                           *
// *                                                                        *
// *    <DeterminantResidualFit>                                            *
// *              -- see below for more details on tags below               *
// *                                                                        *
...
void TaskHandler::doFit(XMLHandler& xmltask, XMLHandler& xmlout,
  ...
  else if (fittype == "SpectrumMethod") {
    try { /*
           */
    } catch (const std::exception& xp) {
      string msg("DetRes fit failed: ");
