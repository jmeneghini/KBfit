...
bool multiLessThan(const T1& u1, const T1& v1, const T2& u2, const T2& v2) {
  return ((u1 < v1) || ((u1 == v1) && (u2 < v2)));
}

template <typename T1, typename T2>
bool multiEqual(const T1& u1, const T1& v1, const T2& u2, const T2& v2) {
  return (u1 == v1) && (u2 == v2);
}

template <typename T1, typename T2>
bool multiNotEqual(const T1& u1, const T1& v1, const T2& u2, const T2& v2) {
  return (u1 != v1) || (u2 != v2);
}
...
bool multiLessThan(const T1& u1, const T1& v1, const T2& u2, const T2& v2,
                   const T3& u3, const T3& v3, const T4& u4, const T4& v4) {
  return ((u1 < v1) ||
          ((u1 == v1) &&
           ((u2 < v2) ||
...
bool multiLessThan(const T1& u1, const T1& v1, const T2& u2, const T2& v2,
                   const T3& u3, const T3& v3, const T4& u4, const T4& v4,
                   const T5& u5, const T5& v5, const T6& u6, const T6& v6) {
  return ((u1 < v1) ||
          ((u1 == v1) &&
           ((u2 < v2) ||
            ((u2 == v2) &&
...
bool multiLessThan(const std::set<T>& u, const std::set<T>& v) {
  ...
  for (ut = u.begin(), vt = v.begin(); (ut != u.end()) && (vt != v.end());
       ut++, vt++) {
    if (*ut < *vt)
      return true;
    if (*ut != *vt)
...
template <typename T> bool allEqual(const T& u1, const T& u2, const T& u3) {
  return (u1 == u2) && (u2 == u3);
}
...
template <typename T> bool allNotEqual(const T& u1, const T& u2, const T& u3) {
  return (u1 != u2) && (u1 != u3) && (u2 != u3);
}

template <typename T>
bool allNotEqual(const T& u1, const T& u2, const T& u3, const T& u4) {
  return (u1 != u2) && (u1 != u3) && (u1 != u4) && (u2 != u3) && (u2 != u4) &&
         (u3 != u4);
}
...
bool allNotEqual(const T& u1, const T& u2, const T& u3, const T& u4,
                 const T& u5) {
  return (u1 != u2) && (u1 != u3) && (u1 != u4) && (u1 != u5) && (u2 != u3) &&
